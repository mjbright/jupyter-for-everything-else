...
"""
   This file retrieved from: https://github.com/emamirazavi/python3-ping
"""
...
#=============================================================================#
def ping(destination, verbose=False):
    class MyStats:
        thisIP   = "0.0.0.0"
        pktsSent = 0
        pktsRcvd = 0
    ...
    # returns msec delay
    return do_one(myStats, destination, destination, timeout=2000, mySeqNumber=1, packet_size=1, quiet=not verbose)
