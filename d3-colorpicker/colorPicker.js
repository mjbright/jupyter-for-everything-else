...
copi.dispatch.on('cpupdate', function(d) {
  hsla=cp.converters.dataToHslaString(d)
  d3.select("body").
  style("background", hsla).
  style("background", "-moz-radial-gradient(center, circle cover, #f7fbfc 0%, " + hsla + " 100%").
  style("background", "-webkit-gradient(radial, center center, 0px, center center, 100%, color-stop(0%, #f7fbfc), color-stop(100%, #ad4944))").
  style("background", "-webkit-radial-gradient(center, circle cover, #f7fbfc 0%, " + hsla + " 100%)").
  style("background", "-o-radial-gradient(center, circle cover, #f7fbfc 0%, " + hsla + " 100%)").
  style("background", "-ms-radial-gradient(center, circle cover, #f7fbfc 0%, " + hsla + " 100%)").
  style("background", "radial-gradient(center, circle cover, #f7fbfc 0%, " + hsla + " 100%)").
